...
#resume_from = './work_dirs/models/xcad_v2_kfold/x6/latest.pth'#'None
resume_from = None#'./work_dirs/models/xcad_v2_kfold/x6/latest.pth'#'None
work_dir = './work_dirs/models/xcad_v2_kfold/x6/'
#load_from = None
